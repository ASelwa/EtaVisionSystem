...
/*const char buf_Rule[36] = {'A',0xc0,0xc0,'+',0xc0,0xc0,'+',0xc0,0xc0,
                           'C',0xc0,0xc0,'+',0xc0,0xc0,'+',0xc0,0xc0,
                           'B',0xc0,0xc0,'+',0xc0,0xc0,'+',0xc0,0xc0,
                           'D',0xc0,0xc0,'+',0xc0,0xc0,'+',0xc0,0xc0};*/

void setHeadingPatern()
{
  int start;
  start = round(GPS_Heading/1000);
  start -= 5;
  if(start < 0) start += 36;
  for(int x=0; x <= 10; x++){
